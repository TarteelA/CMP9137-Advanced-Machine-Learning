...
def train_model(model, ARCHITECTURE, train_loader, criterion, optimiser, scheduler, num_epochs=10):
...
if __name__ == '__main__':
    ...
    optimiser = torch.optim.AdamW(model.parameters(), lr=1e-5, weight_decay=1e-4)  # Smaller learning rate
    scheduler = StepLR(optimiser, step_size=5, gamma=0.1)  # Reduce LR every 5 epochs

    # Train and Evaluate Model
    train_model(model, MODEL_ARCHITECTURE, train_loader, criterion, optimiser, scheduler, num_epochs=10)
